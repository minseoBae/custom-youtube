...
import { webdTexts } from '../data/webd'
import { websiteTexts } from '../data/website'
import { gsapText } from '../data/gsap'
import { portfolioTexts } from '../data/portfolio'
import { youtubeText } from '../data/youtube'
import { developerText } from '../data/developer';
import { todayText } from '../data/today'
import { daejinTexts } from '../data/daejin'
import { musicTexts } from '../data/music'
...
const Home = () => {
    return (
        <Main 
            ...
            <VideoSlider videos={webdTexts} title="😮 웹디자인기능사 준비는 이걸로!" id="webd" />
            ...
            <VideoSlider videos={portfolioTexts} title="🤗 포트폴리오 만드는 방법을 공유합니다." id="portfolio" />
